...
<div class="h-screen flex">
    ...
    <div class="flex w-1/2 bg-gradient-to-tr from-blue-800 to-purple-700 i justify-around items-center">
        <form method="POST" action="/login">
            ...
            <p class="text-white font-normal  mb-7">Welcome Back</p>
            <div class="flex bg-white items-center border-2 py-2 px-3 rounded-2xl mb-4">
            ...
            <div class="flex bg-white items-center border-2 py-2 px-3 rounded-2xl">
            ...
            <span class="text-white ml-2 hover:text-blue-500 cursor-pointer">Forgot Password ?</span>
        </form>
    </div>
</div>
